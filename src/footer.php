...
<section class="footer-section" id="footer">
    <table class="footer-table">
        <tr>
            ...
            <td class="footer-column">
                ...
                <p class="footer-title">DFB Digital</p>
            </td>

            <!-- Second Column: CEO Name and Info -->
            <td class="footer-column">
                <h3 class="footer-heading">JOE FLORES AKA Daddy FunBuckets</h3>
                <span class="footer-row">Chief Innovation Officer</span>
                <span class="footer-row">dfbdigital@gmail.com</span>
                <span class="footer-row">+63 998 886 5824</span>
            </td>
            ...
            <td class="footer-column">
                ...
                <div class="footer-row">
                    ...
                    <span>twitter.com/dfbdigital</span>
                </div>
                <div class="footer-row">
                    <svg class="social-icon" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512"
                    ...
                    <span>facebook.com/dfbdigital</span>
                </div>
                <div class="footer-row">
                    <svg class="social-icon" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512"
                    ...
                    <span>instragram.com/dfbdigital</span>
                </div>
                <div class="footer-row">
                    <svg class="social-icon" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512"
                    ...
                    <span>linkedin.com/dfbdigital</span>
                </div>
            </td>
    ...
    <div>
        <span></span><span></span>
        <p style="text-align: center;"><br>© 2024 DFB Digital | <i> All Rights Reserved</i></p>
    </div>
</section>