                ...
                <table class="hero-table">
                    <tr>
                        <td class="hero-title-column">
                            <div class="hero-title">Do <br> Digital <br> Better!</div>
                        </td>
                ...
                <div class="about-section">
                        ...
                        <tr>
                            <td class="aboutus-title-column">
                                <div class="aboutus-image-container">
                                    <img src="img/p2.png" alt="Descriptive Alt Text">
                                </div>
                            </td>
                            <td class="aboutus-content-column">
                                <p class="aboutus-title">
                                    <span><b>Work 1 Title</b></span>
                                </p>
                                <p class="aboutus-paragraph">
                                    <span>
                                        Get expert guidance, drive revenue, and reach new customers online... and watch
                                        your business GROW... just click below:
                                    </span>
                                </p>
                            </td>
                        </tr>
                    ...
                    <table class="aboutus-table" style="direction: rtl;">
                        <tr>
                            ...
                            <td class="aboutus-content-column" style="direction: ltr;">
                                <p class="aboutus-title">
                                    <span><b>Work 2 Title</b></span>
                                </p>
                                <p class="aboutus-paragraph">
                                    <span>
                                        Discover new strategies to enhance your online presence effectively...
                                    </span>
                                </p>
                            </td>
                        </tr>
                    ...
                    <table class="aboutus-table">
                        <tr>
                            ...
                            <td class="aboutus-content-column">
                                <p class="aboutus-title">
                                    <span><b>Work 3 Title</b></span>
                                </p>
                                <p class="aboutus-paragraph">
                                    <span>
                                        Maximize your digital investments with our expert consulting...
                                    </span>
                                </p>
                            </td>
                        </tr>
                ...
                <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/p3.png" alt="Los Angeles" class="d-block w-100 carousel-image">
                        ...
                        <div class="carousel-item">
                            <img src="img/p3.png" alt="Chicago" class="d-block w-100 carousel-image">
                            <div class="carousel-caption">
                        ...
                        <div class="carousel-item">
                            <img src="img/p3.png" alt="New York" class="d-block w-100 carousel-image">
                            <div class="carousel-caption">
